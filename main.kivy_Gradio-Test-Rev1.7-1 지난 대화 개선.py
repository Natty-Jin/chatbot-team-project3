...
class ProfileScreen(Screen):
    ...
    def start_chat(self, _instance):
        ...
        Clock.schedule_once(lambda dt: chat_screen.update_character(self.current_character), 0.1)
...
class ChatScreen(Screen):
    ...
    def add_message(self, message, align="left", icon_source=None):
        ...
        Clock.schedule_once(lambda dt: self.scroll_view.scroll_to(message_layout), 0.001)
...
save_test_conversation(
    "Erika",
    ["안녕하세요 ~ Erika 입니다! 오늘도 행복한 하루 보내고 있나요 전 독서를 좋아해요."],
)
save_test_conversation(
    "Min",
    [
        "안녕하세요 Min입니더! 오늘은 어떤 모험이 기다리고 있을까예 전 음악을 듣는 걸 좋아해요.",
    ],
)
save_test_conversation(
...
save_test_conversation(
    "NEXA",
    [
        "안녕하세요! 오늘도 멋진 하루 보내세요 저는 리그오브레전드 대회 보는 걸 좋아해요!!",
    ],
)
