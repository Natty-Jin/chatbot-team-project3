...
save_test_conversation(
    "Wynter",
    [
        "안녕하세요~ Wynter입니다. 오늘도 우리nepoiA들과 함께라 행복해요! 언제나 사랑해요!"
    ],
)
save_test_conversation(
    "Erika",
    ["안녕하세요 ~ 오늘도 행복한 하루 보내고 있나요 전 독서를 좋아해요."],
)
save_test_conversation(
    "Min",
    [
...
save_test_conversation(
    "J.K", ["Hey yo 오늘은 뭐하고 계신가yo I'm AI에 관심이 많아 에이 man"]
)
save_test_conversation(
    "Luis",
    ["안녕하세요! 오늘도 무탈히 지나가면 좋겠어요"],
)
save_test_conversation(
    "NEXA",
    [
